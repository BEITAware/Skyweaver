...
using Ferrita.Controls.FerritaPreferencesControl.ViewModels.Pages;
using Ferrita.Controls.FerritaPreferencesControl.Views.Pages;

namespace Ferrita.Controls.FerritaPreferencesControl.Services
{
    public static class FerritaPreferencesRegistration
    {
