...
{
    public sealed class FerritaPreferencesControlViewModel : ObservableObject
    {
        ...
        public FerritaPreferencesControlViewModel()
            : this(null)
        {
        }

        public FerritaPreferencesControlViewModel(Action<string>? openTabByType)
        {
        ...
        public string Title => LocalizationRuntime.Instance.GetString("Preferences.Welcome.Title", "Ferrita 首选项");
