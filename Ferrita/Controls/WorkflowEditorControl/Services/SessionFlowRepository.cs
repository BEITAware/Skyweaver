    ...
    public sealed class SessionFlowRepository
    {
        ...
        private static XElement CreateNodeElement(SessionFlowNodeModel node)
        {
            return new XElement("Node",
                ...
                new XAttribute("ContextInjectionRole", node.ContextInjectionRole),
                new XAttribute("ContextInjectionContent", node.ContextInjectionContent ?? string.Empty),
        ...
        private static SessionFlowNodeModel ParseNode(XElement element)
        {
            var node = new SessionFlowNodeModel
            {
                ...
                ContextInjectionRole = ParseEnum((string?)element.Attribute("ContextInjectionRole"), LanguageModelChatRole.System),
                ContextInjectionContent = ((string?)element.Attribute("ContextInjectionContent") ?? string.Empty).Trim()
            };
