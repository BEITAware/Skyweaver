...
namespace Ferrita.Controls.ChatSessionControl.Views
{
    public partial class PlanItemCheckInvocationCardView : UserControl
    {
        ...
        {
            if (e.OldValue is FerritaToolInvocationPresentationState oldState)
            {
            ...
            if (e.NewValue is FerritaToolInvocationPresentationState newState)
            {
        ...
        {
            if (DataContext is FerritaToolInvocationPresentationState state)
            {
        ...
        private void UpdateDisplays(FerritaToolInvocationPresentationState state)
        {
