...
namespace Ferrita.Controls.ChatSessionControl.Views
{
    ...
    public class MediaResourceIconConverter : IValueConverter
    {
        public object? Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            const string GeneralDocUri = "pack://application:,,,/Ferrita;component/Resources/GeneralDocument.png";
            const string PdfUri = "pack://application:,,,/Ferrita;component/Resources/PDFile.png";
            const string AudioUri = "pack://application:,,,/Ferrita;component/Resources/Audio.png";
            const string VideoUri = "pack://application:,,,/Ferrita;component/Resources/Video.png";
