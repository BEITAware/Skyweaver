...
namespace Ferrita.Services.AerialCityRag
{
    public sealed class AerialCityRagService
    {
        ...
        public async Task<AerialCityRagInitializationResult> InitializeAsync(
            ...
            Func<FerritaToolProgressUpdate, CancellationToken, ValueTask>? progressReporter = null)
        {
            ...
            var aerialCityDirectory = FerritaDirectoryRuntime.Instance.AerialCityDirectoryPath;
        ...
        private static async Task<IReadOnlyList<AerialCityRagFileUpdateOutcome>> ProcessScopeFilesAsync(
            ...
            int maximumFileBytes,
            Func<FerritaToolProgressUpdate, CancellationToken, ValueTask>? progressReporter,
            CancellationToken cancellationToken)
        {
