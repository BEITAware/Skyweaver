...
namespace Ferrita.Services.LiveXaml
{
    ...
    public static class LiveXamlRuntime
    {
            ...
            string xamlFilePath)
        {
            ...
            {
                builder.AppendLine("        [global::System.CodeDom.Compiler.GeneratedCode(\"Ferrita.LiveXaml\", \"1.0\")]");
            ...
            builder.AppendLine($"            global::Ferrita.Services.LiveXaml.LiveXamlRuntime.InitializeGeneratedComponent(this, {ToCSharpStringLiteral(xamlFilePath)});");
            builder.AppendLine("        }");
            builder.AppendLine("    }");
            ...
            ICollection<LiveXamlDiagnostic> diagnostics)
        {
            ...
            var compilation = CSharpCompilation.Create(
                assemblyName: $"Ferrita.LiveXaml.{Guid.NewGuid():N}",
