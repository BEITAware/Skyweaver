...
{
    public sealed class FerritaStreamingToolParameterSnapshot
    {
    ...
    public sealed class FerritaStreamingToolCallSnapshot
    {
        ...
        public IReadOnlyList<FerritaStreamingToolParameterSnapshot> Parameters { get; init; } =
            Array.Empty<FerritaStreamingToolParameterSnapshot>();
    }

    public sealed class FerritaToolInvocationParameterPresentationState : ObservableObject
    {
        private string _name;
        private string _description;
        private FerritaToolParameterType _parameterType;
        private bool _isRequired;
        private string _defaultValue;
        private string _value;
        private bool _isClosed;

        public FerritaToolInvocationParameterPresentationState(string name)
        {
        ...
        public FerritaToolParameterType ParameterType
        {
            get => _parameterType;
        ...
        public void ApplyDefinition(FerritaToolParameterDefinition definition)
        {
    ...
    public sealed class FerritaToolInvocationPresentationState : ObservableObject
    {
        private readonly Dictionary<string, FerritaToolInvocationParameterPresentationState> _parametersByName =
        ...
        public FerritaToolInvocationPresentationState(
            int toolCallIndex,
            string toolName,
            ...
            string? iconPath = null)
        {
            ...
            WeakEventManager<Ferrita.Services.Localization.LocalizationRuntime, System.EventArgs>.AddHandler(
                Ferrita.Services.Localization.LocalizationRuntime.Instance,
                nameof(Ferrita.Services.Localization.LocalizationRuntime.Instance.LanguageChanged),
                OnLanguageChanged);
        }
        ...
        public string ToolDisplayName => Ferrita.Services.Localization.LocalizationRuntime.Instance.GetString($"Tool.{ToolName}.DisplayName", ToolName);
        ...
        public ObservableCollection<FerritaToolInvocationParameterPresentationState> Parameters { get; } = new();
        ...
        public ObservableCollection<FerritaLineDiffEntry> ToolResultDiffLines { get; } = new();
        ...
        public FerritaToolInvocationParameterPresentationState GetOrCreateParameterState(
            ...
            FerritaToolParameterDefinition? definition = null)
        {
            ...
            var state = new FerritaToolInvocationParameterPresentationState(normalizedName);
            if (definition != null)
            {
        ...
        public void EnsureParameterDefinitions(IEnumerable<FerritaToolParameterDefinition>? parameterDefinitions)
        {
        ...
        public void ApplySnapshot(
            ...
            IEnumerable<FerritaToolParameterDefinition>? parameterDefinitions = null)
        {
        ...
        public void ApplyToolProgress(FerritaToolProgressUpdate? progress)
        {
            if (progress == null)
            {
                return;
        ...
        private void RebuildToolResultDiffLines()
        {
            ...
            if (!string.Equals(
                    ...
                    FerritaToolResultPresentationKinds.LineDiffV1,
                    StringComparison.OrdinalIgnoreCase) ||
                !FerritaLineDiffPresentation.TryParseContent(ToolResultContent, out var diffEntries))
            {
                return;
            }
    ...
    public sealed class FerritaToolInvocationPresentationContext
    {
        public FerritaToolInvocationPresentationContext(
    ...
    public interface IFerritaToolInvocationPresentationProvider
    {
        FrameworkElement? CreateInvocationPresentation(FerritaToolInvocationPresentationContext context);
    }

    public interface IFerritaToolConfirmationPresentationProvider
    {
        FrameworkElement? CreateConfirmationPresentation(FerritaToolInvocationPresentationContext context);
    }
}
