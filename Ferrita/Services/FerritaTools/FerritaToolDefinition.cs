...
{
    public sealed class FerritaToolDefinition
    {
        private static readonly Regex s_namePattern = new("^[A-Za-z0-9_-]+$", RegexOptions.Compiled);

        public FerritaToolDefinition(
            string name,
            string description,
            string? iconName = null,
            IReadOnlyList<FerritaToolParameterDefinition>? parameters = null,
            bool isSystemTool = false,
            bool canBelongToToolKit = true,
            FerritaToolDefaultAgentPermission defaultAgentPermission = FerritaToolDefaultAgentPermission.RequireConfirmation,
            ...
            bool supportsAsyncInvocation = true)
        {
            ...
            var normalizedParameters = parameters?.ToArray() ?? Array.Empty<FerritaToolParameterDefinition>();
        ...
        public IReadOnlyList<FerritaToolParameterDefinition> Parameters { get; }

        public bool IsSystemTool { get; }

        public bool CanBelongToToolKit { get; }

        public FerritaToolDefaultAgentPermission DefaultAgentPermission { get; }
