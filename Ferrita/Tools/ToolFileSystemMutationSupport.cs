...
namespace Ferrita.Tools
{
    ...
    internal static class ToolFileSystemMutationSupport
    {
        ...
        {
            return permissionScope == ToolFileSystemPermissionScope.FullAccess
                ? "The model can modify any file or directory path that the Ferrita process account can access. LateralFS shortcuts still work."
    ...
    internal sealed class ToolFileSystemPermissionSettings
    {
        ...
        public static ToolFileSystemPermissionSettings FromConfiguration(
            FerritaToolConfigurationState? configuration,
    ...
    internal sealed class ToolFileSystemPermissionConfigurationPresenter : FerritaToolConfigurationPresenter
    {
        ...
        public ToolFileSystemPermissionConfigurationPresenter(
            FerritaToolConfigurationEditorContext context,
            string rootElementName,
            string toolName)
        {
