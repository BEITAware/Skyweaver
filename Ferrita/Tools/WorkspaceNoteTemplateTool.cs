...
{
    public sealed class WorkspaceNoteTemplateTool : IFerritaTool, IFerritaToolConfigurationProvider, IFerritaToolInvocationPresentationProvider
    {
        public const string ToolName = "WorkspaceNoteTemplate";

        public FerritaToolDefinition Definition => CreateDefaultDefinition();
        ...
        private static FerritaToolDefinition CreateDefaultDefinition()
        {
            return new FerritaToolDefinition(
                ToolName,
