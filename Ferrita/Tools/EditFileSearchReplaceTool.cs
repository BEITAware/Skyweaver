...
namespace Ferrita.Tools
{
        ...
        IFerritaToolPromptDescriptionProvider
    {
        ...
        private static readonly FerritaToolDefinition s_definition = BuildDefinition(new EditFileSearchReplaceToolSettings());
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (search.Length == 0)
                {
                    return FerritaToolResult.Failure("Search string cannot be empty.");
                }
        ...
        private static FerritaToolDefinition BuildDefinition(EditFileSearchReplaceToolSettings settings)
        {
    ...
    internal sealed class EditFileSearchReplaceToolSettings
    {
        ...
        public static EditFileSearchReplaceToolSettings FromConfiguration(FerritaToolConfigurationState? configuration)
        {
    ...
    internal sealed class EditFileSearchReplaceToolConfigurationPresenter : FerritaToolConfigurationPresenter
    {
        private readonly EditFileSearchReplaceToolConfigurationViewModel _viewModel;
        private readonly FrameworkElement _view;

        public EditFileSearchReplaceToolConfigurationPresenter(FerritaToolConfigurationEditorContext context)
        {
            ArgumentNullException.ThrowIfNull(context);
