...
{
    public sealed class ReadThumbnailsTool : IFerritaTool
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            {
                builder.AppendLine($"<FerritaPreservedContent><Image Path=\"{SecurityElement.Escape(sheetPath)}\" /></FerritaPreservedContent>");
            }
            ...
            CancellationToken cancellationToken)
        {
            ...
            for (var sheetIndex = 0; sheetIndex < sheetsToGenerate; sheetIndex++)
            {
                ...
                var tempPath = Path.Combine(Path.GetTempPath(), $"Ferrita_Thumbnails_{Guid.NewGuid():N}.png");
