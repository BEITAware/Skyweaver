...
{
    public sealed class FerritaContextSnapshotTool : IFerritaTool, IFerritaToolInvocationPresentationProvider
    {
        public const string ToolName = "FerritaContextSnapshot";

        private static readonly FerritaToolDefinition s_definition = new(
            ToolName,
            "Reads the current Ferrita runtime context and returns a concise environment snapshot.",
            "GuideBot",
            [
