...
namespace Ferrita.Tools
{
        ...
        IFerritaToolPromptDescriptionProvider
    {
        ...
        private static readonly FerritaToolDefinition s_definition = BuildDefinition(new EditFileRewriteToolSettings());
        ...
        private static FerritaToolDefinition BuildDefinition(EditFileRewriteToolSettings settings)
        {
    ...
    internal sealed class EditFileRewriteToolSettings
    {
        ...
        public static EditFileRewriteToolSettings FromConfiguration(FerritaToolConfigurationState? configuration)
        {
    ...
    internal sealed class EditFileRewriteToolConfigurationPresenter : FerritaToolConfigurationPresenter
    {
        private readonly EditFileRewriteToolConfigurationViewModel _viewModel;
        private readonly FrameworkElement _view;

        public EditFileRewriteToolConfigurationPresenter(FerritaToolConfigurationEditorContext context)
        {
            ArgumentNullException.ThrowIfNull(context);
