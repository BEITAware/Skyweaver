...
namespace Skyweaver.Services.AgentLoop
{
    ...
    internal static class AgentLoopDebugRecorder
    {
        ...
        private static object BuildToolContextRecord(SkyweaverToolContext toolContext)
        {
        ...
        private static object BuildToolInvocationRecord(SkyweaverToolInvocation invocation)
        {
        ...
        private static object BuildToolReturnRecord(SkyweaverToolReturnPayload payload)
        {
