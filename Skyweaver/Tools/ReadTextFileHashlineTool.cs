        ...
        ISkyweaverToolPromptDescriptionProvider
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                {
                    return SkyweaverToolResult.Failure($"Path points to a directory, not a text file: {targetPath.ResolvedPath}");
                }

                if (!File.Exists(targetPath.ResolvedPath))
                {
                    return SkyweaverToolResult.Failure($"Text file not found: {targetPath.ResolvedPath}");
                }
                ...
                {
                    return SkyweaverToolResult.Failure(textFileValidationError);
                }
            ...
            {
                return SkyweaverToolResult.Failure($"Failed to read text file with Hashline: {ex.Message}");
            }
        }
