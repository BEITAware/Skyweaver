...
namespace Skyweaver.Tools
{
    ...
    public sealed class VectorineCreateXamlToolInvocationViewModel : ObservableObject
    {
        ...
        private readonly SkyweaverToolInvocationParameterPresentationState _xamlParameter;
        ...
        public VectorineCreateXamlToolInvocationViewModel(SkyweaverToolInvocationPresentationState state)
        {
